...
func (n XRay) traverse(stack []Pgid, callback func(page *Page, stack []Pgid) error) error {
...
func (n XRay) FindPathsToKey(key []byte) ([][]Pgid, error) {
	var found [][]Pgid
	...
	err = n.traverse([]Pgid{rootPage},
		func(page *Page, stack []Pgid) error {
			if page.Typ() == "leaf" {
